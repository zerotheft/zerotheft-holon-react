...
const AllProposals = () => {
  ...
  const filteredProposals = allProposals && allProposals.filter(item => item.name && item.name.toLowerCase().includes(filterText.toLowerCase()));
  ...
  const FilterComponent = ({ filterText, onFilter, onClear }) => (
    <>
      <TextField id="search" type="text" placeholder="Filter By Theft Amount" aria-label="Search Input" value={filterText} onChange={onFilter} />
