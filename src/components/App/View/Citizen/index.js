            ...
            <DataSection>
                <ul>
					<li>
						...
						<span>David Lambard 
							<div class="verifiedSec"><i class="fa fa-checked"></i> Verified
							</div>
						</span>
					</li>
					...
					<li><strong>Coming</strong> <span><div class="yesText">75% YES</div><div class="noText">45% NO</div></span></li>
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td>45</td>
							<td><span class="yestheft">45% Yes Theft</span> <span class="notheft">34% Notheft</span></td>
							<td>$14.88</td>
							<td><span class="yestheft">45% Yes Theft</span> ></td>
							<td>Theft</td>
							<td>4th Oct 2020</td>
						</tr>
