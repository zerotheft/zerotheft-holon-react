      ...
      <Container>
        ...
        <DataSection>
          <ul>
            <li>
              ...
              <span>
                ...
                <div className="verifiedSec">
                  <i className="fa fa-checked" /> Verified
                </div>
              </span>
            </li>
            <li>
            ...
            <li>
              <strong>Country</strong> <span>United States of America</span>
            </li>
            <li>
            ...
            <li>
              <strong>Date last voted</strong> <span>2021 Jan 22</span>
            </li>
            <li>
              <strong>BTC Blockchain Address</strong>
              <span>asdw54821asdf8w2f4812881854e1</span>
            </li>
          </ul>
        </DataSection>
        <VoteDetailSection>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>45</td>
                <td>
                  <span className="yestheft">45% Yes Theft</span> <span className="notheft">34% Notheft</span>
                </td>
                <td>$14.88</td>
                <td>
