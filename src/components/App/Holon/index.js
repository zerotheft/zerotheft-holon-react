...
// //TODO: I don't think is component is used
// const Areas = () => {
...
//         <TitleSection>
//           <h3>
//             Select which Holon <br />
//             you want to join
//           </h3>
//           <h5>
//             You need a holon on where you will view problems and vote. PICK one you can trust. Picking one outside of
//             your country can be a good thing.
//           </h5>
//         </TitleSection>
//         <AreasWrapper>
//           <div className="areas">
...
//                 className: i =>
//                   `${i.address === get(selectedArea, 'address') ? 'active' : ''} ${i.address === get(selectedHolon, 'id') ? 'local' : ''
//                   }`,
//               }}
//             />
//           </div>
...
//                     <div>
//                       Status: <span style={{ fontWeight: 'bold' }}>{selectedArea.health}</span>
//                     </div>
//                     <Button
//                       style={{ display: 'none' }}
//                       onClick={() => window.open('zerotheft://areas')}
//                       disabled={selectedArea.address === selectedHolon.id}
//                     >
//                       {selectedArea.address === selectedHolon.id ? 'Selected' : 'Select this'} Holon
//                     </Button>
//                   </div>
//                 </div>
...
//                   <div>Description:</div>
//                 </div>
//                 <div className="holonId">
//                   ID: <span>{truncateString(selectedArea.address, 12)}</span>
//                 </div>
//               </>
//             )}
//           </div>
