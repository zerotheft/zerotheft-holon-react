      ...
      <AboutSection>
        <Container>
          <AboutZT>
            <h3>ZeroTheft.net</h3>
            <p>
              ZeroTheft (ZT) is a tool and infrastructure intended to provide a means for citizens to publish researched
              documentation of government corruption. It is built on the premise that corruption can be quantified by a
              specific monetary amount that is “taken” from taxpayers -- this is what is termed “theft”.
            </p>
            <ButtonWrapper>
